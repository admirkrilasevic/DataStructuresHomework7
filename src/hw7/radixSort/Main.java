...
public class Main {
    ...
    //average sorting time: 12.2 seconds - merge and quick sort are faster for complex data
    System.out.println("Writing to file...");

		FileWriter writer = new FileWriter("src/sortedwithradix.csv");
